...
Config.Boilers = true
	...
	Config.Normal_Boilers = true
	Config.High_Boilers = true

--[[Accumulators Toggle]]--
-- Don't like the Accumulators? Here you can switch them off!
Config.Accumulators = true
	...
	Config.Small_Accumulators = true
	Config.Normal_Accumulators = true
	Config.Large_Accumulators = true

--[[Steam Engines Toggle]]--
-- Don't like the Steam Engines? Here you can switch them off!
Config.SteamEngines = true
	...
	Config.Normal_SteamEngines = true
	Config.High_SteamEngines = true

--[[Solar Panels Toggle]]--
-- Don't like the Solar Panels? Here you can switch them off!
Config.SolarPanels = true
	...
	Config.Small_SolarPanels = true
	Config.Normal_SolarPanels = true
	Config.Large_SolarPanels = true